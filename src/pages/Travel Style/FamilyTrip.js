...
import Navbar from '../../components/navbar';
import Footer from '../../components/footer';
import Img1 from '../../../src/assets/img/hero/Trekking/1.jpeg';
import Img2 from '../../../src/assets/img/gallery/Short-Annapurna-Circuit-Trek.jpg';
import Img3 from '../../../src/assets/img/gallery/gosainkundalake.jpg';
import Img4 from '../../../src/assets/img/gallery/img2.jpg';
import Img5 from '../../../src/assets/img/gallery/img2.jpg';
import Img6 from '../../../src/assets/img/gallery/img3.jpg';
import Img7 from '../../../src/assets/img/gallery/img2.jpg';
import Img8 from '../../../src/assets/img/gallery/img2.jpg';
import Img9 from '../../../src/assets/img/gallery/singlebowl.jfif';
import './FamilyTrip.css';
...
const familyTrips = [
  ...
  { slug: 'short-annapurna-base-camp-trek', image: Img5, title: 'Short Annapurna Base Camp Trek', duration: '16 Days', price: 'USD 2395' },
  { slug: 'tamang-heritage-trail-trek', image: Img6, title: 'Tamang Heritage Trail Trek', duration: '18 Days', price: 'USD 1730' },
  { slug: 'annapurna-circuit-trek', image: Img7, title: 'Annapurna Circuit Trek With Tilicho Lake', duration: '18 Days', price: 'USD 1730' },
  { slug: 'mardi-himal-trek', image: Img8, title: 'All Nepal Tour', duration: '18 Days', price: 'USD 1730' },
  { slug: 'mardi-himal-trek', image: Img8, title: 'Best of Nepal Tour', duration: '18 Days', price: 'USD 1730' },
  { slug: 'mardi-himal-trek', image: Img8, title: 'Muktinath Helicopter Tour', duration: '18 Days', price: 'USD 1730' },
  { slug: 'mardi-himal-trek', image: Img8, title: 'Muktinath Tour With Jungle Safari', duration: '18 Days', price: 'USD 1730' },
  { slug: 'mardi-himal-trek', image: Img8, title: '', duration: '18 Days', price: 'USD 1730' },
  { slug: 'mardi-himal-trek', image: Img8, title: 'Mardi Himal Trek from Pokhara', duration: '18 Days', price: 'USD 1730' },
  { slug: 'muldai-view-trek', image: Img9, title: 'Single Bowl Therapy', duration: '19 Days', price: 'USD 1790' },
];
      ...
      <div className="family-trip-section" style={{ backgroundImage: `url(${Img1})` }}>
        ...
        <div className="container text-center" style={{ position: 'relative', zIndex: 2, color: 'white', padding: '20px' }}>
          ...
          <Breadcrumb className="d-flex justify-content-center mt-2" style={{ color: 'white' }}>
            ...
            <Breadcrumb.Item active style={{ color: 'white' }}>Family Trip</Breadcrumb.Item>
          </Breadcrumb>
        </div>
      </div>
