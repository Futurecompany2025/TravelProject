...
import Navbar from '../../components/navbar';
import Footer from '../../components/footer';
import Img1 from '../../../src/assets/img/hero/Trekking/40.jpg';
import Img2 from '../../../src/assets/img/hero/Trekking/2.jpeg';
import Img3 from '../../../src/assets/img/hero/Trekking/15.jpeg';
import Img4 from '../../../src/assets/img/gallery/img.jpeg';
import Img5 from '../../../src/assets/img/gallery/img2.jpg';
import Img6 from '../../../src/assets/img/gallery/img3.jpg';
import Img7 from '../../../src/assets/img/gallery/img.jpeg';
      ...
      <div className="family-trip-section" style={{ backgroundImage: `url(${Img1})` }}>
        ...
        <div className="container text-center" style={{ position: 'relative', zIndex: 2, color: 'white', padding: '20px' }}>
          ...
          <Breadcrumb className="d-flex justify-content-center mt-2" style={{ color: 'white' }}>
            ...
            <Breadcrumb.Item active style={{ color: 'white' }}>Group Travel</Breadcrumb.Item>
          </Breadcrumb>
        </div>
      </div>
      <div className="content-section" style={{ backgroundColor: '#e8ebf3', padding: '20px' }}>
