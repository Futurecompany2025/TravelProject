...
import Navbar from '../../components/navbar';
import Footer from '../../components/footer';
import Img1 from '../../../src/assets/img/gallery/kailash.jfif';
import Img2 from '../../../src/assets/img/gallery/chardham.jfif';
import Img3 from '../../../src/assets/img/gallery/amarnath.jpg';
import Img4 from '../../../src/assets/img/gallery/goldentemple.jpg';
import Img5 from '../../../src/assets/img/gallery/vaishno.jpg';
import Img6 from '../../../src/assets/img/gallery/tirupati.jpg';
import Img7 from '../../../src/assets/img/gallery/rishikesh.jfif';
import Img8 from '../../../src/assets/img/gallery/img2.jpg';
import './ReligiousTravel.css'; // Ensure you have a CSS file for styling
      ...
      <div className="family-trip-section" style={{ backgroundImage: `url(${Img1})` }}>
        ...
        <div className="container text-center" style={{ position: 'relative', zIndex: 2, color: 'white', padding: '20px' }}>
          ...
          <Breadcrumb className="d-flex justify-content-center mt-2" style={{ color: 'white' }}>
            ...
            <Breadcrumb.Item active style={{ color: 'white' }}> Religious Travel</Breadcrumb.Item>
          </Breadcrumb>
        </div>
      </div>
      <div className="content-section" style={{ backgroundColor: '#e8ebf3', padding: '20px' }}>
